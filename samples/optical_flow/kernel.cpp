...
static void tensor_weight_y_5(ap_fixed<32, 20>* tensor_weight_y_5_out_product_5, ap_fixed<32, 20>* tensor_weight_y_5_tensor_y_5) {
    ...
    t_w[2] = 3.243000e-01f;
      for (ap_int<32> x = 0; x < 1024; ++x) {
    for (ap_int<32> y_reuse = 0; y_reuse < 438; ++y_reuse) {
      #pragma HLS pipeline
      #pragma HLS dependence variable=tensor_weight_y_5_out_product_5_reuse inter false
        ...
        //if (2 <= y_reuse) {
        //  if ((3 <= y_reuse) && (y_reuse < 437)) {
            ap_fixed<32, 20> reducer19;
            reducer19 = ((ap_fixed<32, 20>)0);
            for (ap_int<32> rdx_y = 0; rdx_y < 3; ++rdx_y) {
              reducer19 = ((ap_fixed<32, 20>)((((float)tensor_weight_y_5_out_product_5_reuse[(rdx_y)][x]) * t_w[rdx_y]) + ((float)reducer19)));
            }
            tensor_weight_y_5_tensor_y_5[((x + (y_reuse * 1024)) + -2048)] = reducer19;
          //}
        //}
      }
    }
    ...
    for (ap_int<32> y_reuse = 0; y_reuse < 438; ++y_reuse) {
      ...
      #pragma HLS dependence variable=tensor_weight_y_4_out_product_4_reuse inter false
        ...
        //   if ((3 <= y_reuse) && (y_reuse < 437)) {
            ...
            for (ap_int<32> rdx_y = 0; rdx_y < 3; ++rdx_y) {
              reducer18 = ((ap_fixed<32, 20>)((((float)tensor_weight_y_4_out_product_4_reuse[(rdx_y)][x]) * t_w[rdx_y]) + ((float)reducer18)));
            }
            tensor_weight_y_4_tensor_y_4[((x + (y_reuse * 1024)) + -2048)] = reducer18;
          // }
       // }
      }
    }
    ...
    for (ap_int<32> y_reuse = 0; y_reuse < 438; ++y_reuse) {
      ...
      #pragma HLS dependence variable=tensor_weight_y_3_out_product_3_reuse inter false
        ...
        //   if ((3 <= y_reuse) && (y_reuse < 437)) {
            ...
            for (ap_int<32> rdx_y = 0; rdx_y < 3; ++rdx_y) {
              reducer17 = ((ap_fixed<32, 20>)((((float)tensor_weight_y_3_out_product_3_reuse[(rdx_y)][x]) * t_w[rdx_y]) + ((float)reducer17)));
            }
            tensor_weight_y_3_tensor_y_3[((x + (y_reuse * 1024)) + -2048)] = reducer17;
        //  }
       // }
      }
    }
    ...
    for (ap_int<32> y_reuse = 0; y_reuse < 438; ++y_reuse) {
      ...
      #pragma HLS dependence variable=tensor_weight_y_2_out_product_2_reuse inter false
       ...
       //    if ((3 <= y_reuse) && (y_reuse < 437)) {
            ...
            for (ap_int<32> rdx_y = 0; rdx_y < 3; ++rdx_y) {
              reducer16 = ((ap_fixed<32, 20>)((((float)tensor_weight_y_2_out_product_2_reuse[(rdx_y)][x]) * t_w[rdx_y]) + ((float)reducer16)));
            }
            tensor_weight_y_2_tensor_y_2[((x + (y_reuse * 1024)) + -2048)] = reducer16;
        //  }
        //}
      }
    }
    ...
    for (ap_int<32> y_reuse = 0; y_reuse < 438; ++y_reuse) {
      ...
      #pragma HLS dependence variable=tensor_weight_y_1_out_product_1_reuse inter false
       ...
       //   if ((3 <= y_reuse) && (y_reuse < 437)) {
            ...
            for (ap_int<32> rdx_y = 0; rdx_y < 3; ++rdx_y) {
              reducer15 = ((ap_fixed<32, 20>)((((float)tensor_weight_y_1_out_product_1_reuse[(rdx_y)][x]) * t_w[rdx_y]) + ((float)reducer15)));
            }
            tensor_weight_y_1_tensor_y_1[((x + (y_reuse * 1024)) + -2048)] = reducer15;
        //  }
        //}
      }
    }
    ...
    for (ap_int<32> y_reuse = 0; y_reuse < 438; ++y_reuse) {
      ...
      #pragma HLS dependence variable=tensor_weight_y_0_out_product_0_reuse inter false
        ...
        //  if ((3 <= y_reuse) && (y_reuse < 437)) {
            ...
            for (ap_int<32> rdx_y = 0; rdx_y < 3; ++rdx_y) {
              reducer14 = ((ap_fixed<32, 20>)((((float)tensor_weight_y_0_out_product_0_reuse[(rdx_y)][x]) * t_w[rdx_y]) + ((float)reducer14)));
            }
            tensor_weight_y_0_tensor_y_0[((x + (y_reuse * 1024)) + -2048)] = reducer14;
        //  }
        //}
      }
    }
...
static void tensor_weight_x_5(ap_fixed<32, 20>* tensor_weight_x_5_tensor_y_5, ap_fixed<32, 20>* tensor_weight_x_5_tensor_5) {
    ...
    t_w[2] = 3.243000e-01f;
    for (ap_int<32> y = 0; y < 436; ++y) {
      for (ap_int<32> x_reuse = 0; x_reuse < 1026; ++x_reuse) {
        ...
        //if (2 <= x_reuse) {
        //  if ((3 <= x_reuse) && (x_reuse < 1025)) {
            ap_fixed<32, 20> reducer13;
            reducer13 = ((ap_fixed<32, 20>)0);
            for (ap_int<32> rdx_x = 0; rdx_x < 3; ++rdx_x) {
              reducer13 = ((ap_fixed<32, 20>)((((float)tensor_weight_x_5_tensor_y_5_reuse[0][(rdx_x)]) * t_w[rdx_x]) + ((float)reducer13)));
            }
            tensor_weight_x_5_tensor_5[((x_reuse + (y * 1024)) + -2)] = reducer13;
        //  }
        //}
      }
    }
    ...
    for (ap_int<32> y = 0; y < 436; ++y) {
      for (ap_int<32> x_reuse = 0; x_reuse < 1026; ++x_reuse) {
        ...
        //  if ((3 <= x_reuse) && (x_reuse < 1025)) {
            ...
            for (ap_int<32> rdx_x = 0; rdx_x < 3; ++rdx_x) {
              reducer12 = ((ap_fixed<32, 20>)((((float)tensor_weight_x_4_tensor_y_4_reuse[0][(rdx_x)]) * t_w[rdx_x]) + ((float)reducer12)));
            }
            tensor_weight_x_4_tensor_4[((x_reuse + (y * 1024)) + -2)] = reducer12;
        //  }
        //}
      }
    }
    ...
    for (ap_int<32> y = 0; y < 436; ++y) {
      for (ap_int<32> x_reuse = 0; x_reuse < 1026; ++x_reuse) {
       ...
       //   if ((3 <= x_reuse) && (x_reuse < 1025)) {
            ...
            for (ap_int<32> rdx_x = 0; rdx_x < 3; ++rdx_x) {
              reducer11 = ((ap_fixed<32, 20>)((((float)tensor_weight_x_3_tensor_y_3_reuse[0][(rdx_x)]) * t_w[rdx_x]) + ((float)reducer11)));
            }
            tensor_weight_x_3_tensor_3[((x_reuse + (y * 1024)) + -2)] = reducer11;
       //   }
       // }
      }
    }
...
static void tensor_weight_x_2(ap_fixed<32, 20>* tensor_weight_x_2_tensor_y_2, ap_fixed<32, 20>* tensor_weight_x_2_tensor_2) {
    ...
    for (ap_int<32> y = 0; y < 436; ++y) {
      ...
      //    if ((3 <= x_reuse) && (x_reuse < 1025)) {
            ...
            for (ap_int<32> rdx_x = 0; rdx_x < 3; ++rdx_x) {
              reducer10 = ((ap_fixed<32, 20>)((((float)tensor_weight_x_2_tensor_y_2_reuse[0][(rdx_x)]) * t_w[rdx_x]) + ((float)reducer10)));
            }
            tensor_weight_x_2_tensor_2[((x_reuse + (y * 1024)) + -2)] = reducer10;
      //    }
      //  }
      }
    }
...
static void tensor_weight_x_1(ap_fixed<32, 20>* tensor_weight_x_1_tensor_y_1, ap_fixed<32, 20>* tensor_weight_x_1_tensor_1) {
    ...
    for (ap_int<32> y = 0; y < 436; ++y) {
      ...
      //    if ((3 <= x_reuse) && (x_reuse < 1025)) {
            ...
            for (ap_int<32> rdx_x = 0; rdx_x < 3; ++rdx_x) {
              reducer9 = ((ap_fixed<32, 20>)((((float)tensor_weight_x_1_tensor_y_1_reuse[0][(rdx_x)]) * t_w[rdx_x]) + ((float)reducer9)));
            }
            tensor_weight_x_1_tensor_1[((x_reuse + (y * 1024)) + -2)] = reducer9;
       //   }
       // }
      }
    }
    ...
    for (ap_int<32> y = 0; y < 436; ++y) {
      for (ap_int<32> x_reuse = 0; x_reuse < 1026; ++x_reuse) {
       ...
       //   if ((3 <= x_reuse) && (x_reuse < 1025)) {
            ...
            for (ap_int<32> rdx_x = 0; rdx_x < 3; ++rdx_x) {
              reducer8 = ((ap_fixed<32, 20>)((((float)tensor_weight_x_0_tensor_y_0_reuse[0][(rdx_x)]) * t_w[rdx_x]) + ((float)reducer8)));
            }
            tensor_weight_x_0_tensor_0[((x_reuse + (y * 1024)) + -2)] = reducer8;
       //   }
       // }
      }
    }
...
static void grad_weight_x_2(ap_fixed<32, 20>* grad_weight_x_2_y_filt_2, ap_fixed<32, 20>* grad_weight_x_2_filt_grad_2) {
    ...
    g_f[6] = 7.550000e-02f;
    for (ap_int<32> y = 0; y < 436; ++y) {
      for (ap_int<32> x_reuse = 0; x_reuse < 1030; ++x_reuse) {
      #pragma HLS pipeline
       ...
       // if (6 <= x_reuse) {
       //   if ((9 <= x_reuse) && (x_reuse < 1027)) {
            ap_fixed<32, 20> reducer7;
            reducer7 = ((ap_fixed<32, 20>)0);
            for (ap_int<32> rdx = 0; rdx < 7; ++rdx) {
              reducer7 = ((ap_fixed<32, 20>)((((float)grad_weight_x_2_y_filt_2_reuse[0][(rdx)]) * g_f[rdx]) + ((float)reducer7)));
            }
            grad_weight_x_2_filt_grad_2[((x_reuse + (y * 1024)) + -6)] = reducer7;
       //   }
       // }
      }
    }
    ...
    for (ap_int<32> y = 0; y < 436; ++y) {
      ...
      #pragma HLS pipeline
       ...
       //   if ((9 <= x_reuse) && (x_reuse < 1027)) {
            ...
            for (ap_int<32> rdx = 0; rdx < 7; ++rdx) {
              reducer6 = ((ap_fixed<32, 20>)((((float)grad_weight_x_1_y_filt_1_reuse[0][(rdx)]) * g_f[rdx]) + ((float)reducer6)));
            }
            grad_weight_x_1_filt_grad_1[((x_reuse + (y * 1024)) + -6)] = reducer6;
        //  }
        //}
      }
    }
    ...
    for (ap_int<32> y = 0; y < 436; ++y) {
      ...
      #pragma HLS pipeline
       ...
       //   if ((9 <= x_reuse) && (x_reuse < 1027)) {
            ...
            for (ap_int<32> rdx = 0; rdx < 7; ++rdx) {
              reducer5 = ((ap_fixed<32, 20>)((((float)grad_weight_x_0_y_filt_0_reuse[0][(rdx)]) * g_f[rdx]) + ((float)reducer5)));
            }
            grad_weight_x_0_filt_grad_0[((x_reuse + (y * 1024)) + -6)] = reducer5;
       //   }
       // }
      }
    }
...
static void grad_weight_y_2(ap_fixed<32, 20>* grad_weight_y_2_grad_z, ap_fixed<32, 20>* grad_weight_y_2_y_filt_2) {
    ...
    g_f[6] = 7.550000e-02f;
      for (ap_int<32> x = 0; x < 1024; ++x) {
    for (ap_int<32> y_reuse = 0; y_reuse < 442; ++y_reuse) {
      #pragma HLS pipeline
      #pragma HLS dependence variable=grad_weight_y_2_grad_z_reuse inter false
       ...
       // if (6 <= y_reuse) {
       //   if ((9 <= y_reuse) && (y_reuse < 439)) {
            ap_fixed<32, 20> reducer4;
            reducer4 = ((ap_fixed<32, 20>)0);
            for (ap_int<32> rdx = 0; rdx < 7; ++rdx) {
              reducer4 = ((ap_fixed<32, 20>)((((float)grad_weight_y_2_grad_z_reuse[(rdx)][x]) * g_f[rdx]) + ((float)reducer4)));
            }
            grad_weight_y_2_y_filt_2[((x + (y_reuse * 1024)) + -6144)] = reducer4;
       //   }
       // }
      }
    }
...
static void grad_weight_y_1(ap_fixed<32, 20>* grad_weight_y_1_grad_y, ap_fixed<32, 20>* grad_weight_y_1_y_filt_1) {
    ...
    for (ap_int<32> y_reuse = 0; y_reuse < 442; ++y_reuse) {
      ...
      //    if ((9 <= y_reuse) && (y_reuse < 439)) {
            ...
            for (ap_int<32> rdx = 0; rdx < 7; ++rdx) {
              reducer3 = ((ap_fixed<32, 20>)((((float)grad_weight_y_1_grad_y_reuse[(rdx)][x]) * g_f[rdx]) + ((float)reducer3)));
            }
            grad_weight_y_1_y_filt_1[((x + (y_reuse * 1024)) + -6144)] = reducer3;
       //   }
       // }
      }
    }
    ...
    for (ap_int<32> x = 0; x < 1024; ++x) {
      ...
      #pragma HLS dependence variable=grad_weight_y_0_grad_x_reuse inter false
       ...
       //   if ((9 <= y_reuse) && (y_reuse < 439)) {
            ...
            for (ap_int<32> rdx = 0; rdx < 7; ++rdx) {
              reducer2 = ((ap_fixed<32, 20>)((((float)grad_weight_y_0_grad_x_reuse[(rdx)][x]) * g_f[rdx]) + ((float)reducer2)));
            }
            grad_weight_y_0_y_filt_0[((x + (y_reuse * 1024)) + -6144)] = reducer2;
      //    }
      //  }
      }
    }
...
static void calc_y_gradient(ap_fixed<32, 20>* calc_y_gradient_input_image_1, ap_fixed<32, 20>* calc_y_gradient_grad_y) {
    ...
    g_w[4] = 1;
    for (ap_int<32> x = 0; x < 1024; ++x) {
      for (ap_int<32> y_reuse = 0; y_reuse < 440; ++y_reuse) {
      #pragma HLS pipeline
      ...
      //  if (4 <= y_reuse) {
      //    if ((((6 <= y_reuse) && (y_reuse < 438)) && (2 <= x)) && (x < 1022)) {
            ...
            calc_y_gradient_grad_y[((x + (y_reuse * 1024)) + -4096)] = reducer1;
      //    }
      //  }
      }
    }
...
static void calc_x_gradient(ap_fixed<32, 20>* calc_x_gradient_input_image_0, ap_fixed<32, 20>* calc_x_gradient_grad_x) {
    ...
    g_w[4] = 1;
    for (ap_int<32> y = 0; y < 436; ++y) {
      for (ap_int<32> x_reuse = 0; x_reuse < 1028; ++x_reuse) {
      #pragma HLS pipeline
      ...
      //  if (4 <= x_reuse) {
      //    if ((((2 <= y) && (y < 434)) && (6 <= x_reuse)) && (x_reuse < 1026)) {
            ...
            calc_x_gradient_grad_x[((x_reuse + (y * 1024)) + -4)] = reducer0;
      //    }
      //  }
      }
    }
